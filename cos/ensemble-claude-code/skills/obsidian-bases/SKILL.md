...
6. **Validate syntax against this reference**: confirm the file parses as YAML and follows the schema and quoting rules below (this is the check you can complete here). Rendering in Obsidian — whether the view actually displays — cannot be checked from here; report it as **unverified**, for a human to confirm by opening the `.base` file in Obsidian
