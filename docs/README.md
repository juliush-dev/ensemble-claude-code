...
- **Claude Code**, installed and on the `PATH`. The launcher calls `claude`. Run the latest version: this COS is kept current with the latest Claude Code, and several of its guards rely on recent harness fixes.
